...
# Profile shapes for past_len: min=1, opt=100, max=500
# Generate the --minShapes, --optShapes, --maxShapes strings
MIN_SHAPES="input_embeds:1x1x1024,position_ids:1x1"
OPT_SHAPES="input_embeds:1x1x1024,position_ids:1x1"
MAX_SHAPES="input_embeds:1x1x1024,position_ids:1x1"

for i in $(seq 0 27); do
    MIN_SHAPES="${MIN_SHAPES},past_key_${i}:1x8x1x128,past_value_${i}:1x8x1x128"
